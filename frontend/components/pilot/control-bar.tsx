        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-6 lg:flex lg:gap-8 w-full lg:w-auto">
            <div className="flex flex-row items-center gap-2">
              <span className="text-sm text-muted-foreground font-mono whitespace-nowrap w-[4.5rem]">活动任务</span>
              <Badge variant="outline" className="font-mono h-6 px-2 min-w-[2rem] justify-center bg-background">
                {stats?.active_tasks ?? 0}
              </Badge>
            </div>
            <div className="flex flex-row items-center gap-2">
              <span className="text-sm text-muted-foreground font-mono whitespace-nowrap w-[4.5rem]">待下载</span>
              <Badge variant="outline" className="font-mono h-6 px-2 min-w-[2rem] justify-center bg-background">
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              <Badge 
                variant={config?.download.enabled ? "default" : "outline"} 
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              <Badge 
                variant={config?.cleanup.enabled ? "default" : "outline"}
                className="h-6 px-2 w-fit justify-center"
              >
          ...
          {/* 分隔线 - 仅移动端显示 */}
          <div className="h-0.5 bg-border/20 lg:hidden w-full" />
