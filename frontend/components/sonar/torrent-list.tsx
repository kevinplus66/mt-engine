            ...
            <TableHeader>
              <TableRow>
                ...
                <SortableTableHead
                  ...
                  onSort={onSort}
                  className="w-[120px] min-w-[120px] max-w-[120px] sticky right-[210px] bg-black dark:bg-white z-20 shadow-[-1px_0_0_0_rgba(255,255,255,0.2)] dark:shadow-[-1px_0_0_0_rgba(0,0,0,0.1)]"
                >
                  大小
                </SortableTableHead>
                <SortableTableHead
            ...
            <TableBody ref={tableBodyRef}>
              {torrents.map((torrent) => (
                <TableRow key={torrent.id}>
                  ...
                  <TableCell className="whitespace-nowrap sticky right-[210px] w-[120px] min-w-[120px] max-w-[120px] bg-card group-hover:bg-gray-100 dark:group-hover:bg-zinc-800 z-10 shadow-[-1px_0_0_0_rgba(0,0,0,0.1)] dark:shadow-[-1px_0_0_0_rgba(255,255,255,0.1)]">
                    {torrent.size_display}
                  </TableCell>
                  <TableCell className="sticky right-[90px] w-[120px] min-w-[120px] max-w-[120px] bg-card group-hover:bg-gray-100 dark:group-hover:bg-zinc-800 z-10">
          ...
          <TableHeader>
            <TableRow>
              ...
              <SortableTableHead
                ...
                sortDirection={getSortDirection("size")}
                onSort={onSort}
                className="w-[120px] min-w-[120px] max-w-[120px] sticky right-[510px] bg-black dark:bg-white z-20 shadow-[-1px_0_0_0_rgba(255,255,255,0.2)] dark:shadow-[-1px_0_0_0_rgba(0,0,0,0.1)]"
              >
                大小
              </SortableTableHead>
              <TableHead className="w-[90px] min-w-[90px] max-w-[90px] sticky right-[420px] bg-black dark:bg-white z-20">分类</TableHead>
              <SortableTableHead
                sortKey="seeders"
                sortDirection={getSortDirection("seeders")}
                onSort={onSort}
                className="w-[120px] min-w-[120px] max-w-[120px] sticky right-[300px] bg-black dark:bg-white z-20"
              >
                做种/下载
              </SortableTableHead>
              <TableHead className="w-[100px] min-w-[100px] max-w-[100px] sticky right-[200px] bg-black dark:bg-white z-20">状态</TableHead>
              <SortableTableHead
                sortKey="remaining"
                sortDirection={getSortDirection("remaining")}
                onSort={onSort}
                className="w-[100px] min-w-[100px] max-w-[100px] sticky right-[100px] bg-black dark:bg-white z-20"
              >
                剩余时间
              </SortableTableHead>
          ...
          <TableBody ref={tableBodyRef}>
            {torrents.map((torrent) => (
              <TableRow key={torrent.id}>
                ...
                <TableCell className="whitespace-nowrap sticky right-[510px] w-[120px] min-w-[120px] max-w-[120px] bg-card group-hover:bg-gray-100 dark:group-hover:bg-zinc-800 z-10 shadow-[-1px_0_0_0_rgba(0,0,0,0.1)] dark:shadow-[-1px_0_0_0_rgba(255,255,255,0.1)]">
                  {torrent.size_display}
                </TableCell>
                <TableCell className="sticky right-[420px] w-[90px] min-w-[90px] max-w-[90px] bg-card group-hover:bg-gray-100 dark:group-hover:bg-zinc-800 z-10">
                ...
                <TableCell className="sticky right-[300px] w-[120px] min-w-[120px] max-w-[120px] bg-card group-hover:bg-gray-100 dark:group-hover:bg-zinc-800 z-10">
                ...
                <TableCell className="sticky right-[200px] w-[100px] min-w-[100px] max-w-[100px] bg-card group-hover:bg-gray-100 dark:group-hover:bg-zinc-800 z-10">
                  {(() => {
                ...
                <TableCell
                  className={`text-sm whitespace-nowrap font-medium sticky right-[100px] w-[100px] min-w-[100px] max-w-[100px] bg-card group-hover:bg-gray-100 dark:group-hover:bg-zinc-800 z-10 ${
