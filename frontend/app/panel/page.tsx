...
import { ShareRatioChart } from "@/components/panel/share-ratio-chart";
    ...
    <PageTransition>
      <div className="min-h-screen bg-background p-4 md:p-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
          <span>PANEL</span>
          <span className="text-base font-normal text-muted-foreground">· 数据面板</span>
        </h1>
        ...
        {/* 分享率趋势图 */}
        {!isLoading && <ShareRatioChart timeRange={timeRange} />}
