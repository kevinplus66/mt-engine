...
### 你应该能看到：
- 一个漂亮的深色界面（"Nothing OS" 风格）
- **免费猎手页面**：显示当前所有 Free 和 2xFree 种子
- **搜索引擎页面**：点击右上角 Logo 切换到搜索引擎
- 每个种子的剩余免费时间
- 你的做种/下载状态
...
- **搜索引擎页面**：
  - 模式选择：综合 / 电影 / 电视剧 / 成人
  - 高级筛选：分辨率（4K/1080p/720p等）
  - 视频编码：H.265/H.264/AV1等
  - 音频编码：DTS/AAC/Atmos等
  - 排序：上传时间 / 大小 / 做种数 / 下载数
  - 无限滚动分页
  - 一键下载到 qBittorrent
...
**You should see:**
- Beautiful "Nothing OS" style dark interface
- **Free Hunter page**: Shows all Free/2xFree torrents
- **Search Engine page**: Click logo in top-right to switch to search engine
- Remaining free time for each torrent
